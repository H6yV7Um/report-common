package com.sm.report;

import com.sm.report.calcite.simple.MemorySchema;
import com.sm.report.calcite.simple.MemorySchemaFactory;
...
public class SimpleTest {
	...
	public void before() {
		try {
			...
			connection = DriverManager.getConnection("jdbc:calcite:model=/Users/likangning/study/report-common/calcite/src/main/resources/School.json", info);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
